...
日期：2026-06-28
收录时间：2026/6/28 16:22:52 Asia/Shanghai
...
- 余额监控失败：读取到的余额字段异常（data.total_available=-660344274），未将其当作真实人民币余额；请配置正确的 MICU_API_BALANCE_JSON_PATH。
...
- 余额提醒：余额监控失败：读取到的余额字段异常（data.total_available=-660344274），未将其当作真实人民币余额；请配置正确的 MICU_API_BALANCE_JSON_PATH。
