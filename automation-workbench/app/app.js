...
let bridgeBaseUrl = "";
const CLOUD_TEMPLATE_URL = "https://dfx706544-cell.github.io/Codex-second-brain-workbench-模板作者/automation-workbench/app/";
const dataHub = {
  knowledge: [],
  history: [],
  dailyBriefs: [],
...
function buildPersonalWorkbenchPrompt(config = collectPersonalWorkbenchConfig()) {
  return `请基于 模板作者 的第二大脑自动化工作台公共模板，帮我搭建一个属于我自己的个性化自动化工作台。
